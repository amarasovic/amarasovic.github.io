...
I am an Assistant Professor at the [School of Computing](https://www.cs.utah.edu/) at the University of Utah. My primary research interests are at the confluence of **natural language processing (NLP)**, **explainable artificial intelligence (XAI)**, and **multimodality**. I am interested in projects that **rigorously validate** AI technologies and those that make human **interaction** with them **more intuitive**. As an example of the former you can see our work on carefully designing benchmarks to validate robustness of question answering model in the presence of common linguistic phenomena such as [coreference](https://aclanthology.org/D19-1606/).                    
